...
namespace SamplesTest
{
    public class SamplesTestRun
    {
        ...
        public void NetMessagingSessionTest()
        {
            ...
            Assert.Equal(0, NetMessagingSessionService.Program.Main(new string[0]));
        }

        [Fact]
        public void AtomicTransactionsTest()
        {
            Assert.Equal(0, AtomicTransactions.Program.Main(new string[0]));
        }

        [Fact(Skip = "Enable for MSMQ")]
        public void DurableSenderTest()
        {
            Assert.Equal(0, DurableSenderClient.Program.Main(new string[0]));
